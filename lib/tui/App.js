...
/**
 * @typedef {'update-existing'|'main'|'browse-groups'|'browse-skills'|'scope'|'targets'|'status'|'apply'|'manage'|'keys'|'key-input'|'confirm-exit'|'global-uninstall'|'message'} Screen
 */
