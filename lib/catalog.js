...
export const CORE_SKILLS = [
  ...
  },
  {
    ...
    hint: 'epic→features→OM tasks (what/why); scout + auditor agents',
  },
...
export const SKILL_GROUPS = [
  ...
  },
  {
    id: 'core',
    label: 'Core',
    hint: 'default craft: OM, beads-om, capability-plan, design, refactor',
    defaultSelected: true,
    skills: CORE_SKILLS,
  },
  {
...
/** OM + planning roster (install together when any puller skill is selected). */
...
/**
 * Skills that pull the agent roster when installed.
 * operating-mode / capability-plan are kernels; simple-design / refactoring are preloads.
 * beads-om and full beads do not install agents.
 */
