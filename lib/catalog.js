...
export const CORE_SKILLS = [
  ...
  { id: 'refactoring', label: 'refactoring', hint: 'Fowler mechanics + smells' },
  {
    ...
    hint: 'scan repo → write/refresh AGENTS.md for agents',
  },
];
...
export const OPT_IN_SKILLS = [
  { id: 'audit-architecture', label: 'audit-architecture', hint: 'evidenced complexity and boundary audit' },
  { id: 'audit-verification', label: 'audit-verification', hint: 'reliable setup, diagnostics, and checks' },
  { id: 'audit-simplification', label: 'audit-simplification', hint: 'bounded simplification and stuck-work recovery' },
  { id: 'audit-performance', label: 'audit-performance', hint: 'measure bottlenecks and verify gains' },
  { id: 'audit-repository', label: 'audit-repository', hint: 'backlog triage and authorized delivery' },
  ...
  {
    id: 'arxiv-prior-art',
    label: 'arxiv-prior-art',
    hint: 'check arXiv prior art before non-trivial design',
  },
  {
    id: 'c4-model',
    label: 'c4-model',
    hint: 'C4 architecture diagrams (context → code)',
  },
];
...
export const SKILL_GROUPS = [
  ...
  },
  {
    id: 'core',
    label: 'Core',
    hint: 'default craft: simple-design, refactoring, repo-discovery',
    defaultSelected: true,
    skills: CORE_SKILLS,
  },
  {
    id: 'opt_in',
    label: 'Opt-in',
    hint: 'audits / architecture / distributed / geometry / arXiv / C4 — never default-yes',
