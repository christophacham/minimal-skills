...
export const OTHER_SKILLS = [
  { id: 'work-loop', label: 'work-loop', hint: 'one-unit implement → review cycle' },
  { id: 'work-plan', label: 'work-plan', hint: 'design panel + short beads' },
  { id: 'bd-epic-runner', label: 'bd-epic-runner', hint: 'run all ready epic children' },
  { id: 'beads', label: 'beads', hint: 'bd issue tracker integration' },
  { id: 'peek-repo', label: 'peek-repo', hint: 'shallow-clone GitHub for inspection' },
  { id: 'architecture-design', label: 'architecture-design', hint: 'Clean Arch / DDD / SOLID' },
  {
    id: 'architectural-decomposition',
    label: 'architectural-decomposition',
    hint: 'monolith → services patterns',
  },
  {
    id: 'distributed-architecture',
    label: 'distributed-architecture',
    hint: 'sagas, topology, DB ownership',
  },
...
/** Skills that should install pool.md when installed. */
export const SKILLS_NEEDING_POOL = new Set(['work-loop', 'work-plan']);
