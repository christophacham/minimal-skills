 ...
 * @param {{ skills?: string[], agents?: string[], panelists?: string[], pool?: boolean }} delta
 */
...
export function manifestHasAnything(m = loadManifest()) {
  return m.skills.length > 0 || m.agents.length > 0 || m.panelists.length > 0 || m.pool;
}
