...
export function removePool(scope, projectRoot) {
  return forceRemove(poolDest(scope, projectRoot));
}

/**
 * Install a set of skills into the claude tree and auto-attach agents/pool when needed.
