...
`skill-creator` for the selected project, then offers remaining skills
individually as global/project/skip. Global means `~/.claude`; project means
`<project>/.claude`. It does not install to `.agents/`.
