...
foreach ($stale in @('tmp-clone', 'web-ddgs', 'work-loop', 'work-plan', 'bd-epic-runner', 'architectural-decomposition', 'mission-planning', 'reimpl-scout', 'dynamic-context-injection', 'testing-tdd', 'third-party-integration')) {
