...
npx -y github:christophacham/claude-skills#v1.0.9
```

Same idea with Bun:

```sh
bunx github:christophacham/claude-skills#v1.0.9
```
...
Check what you ran: `npx -y github:christophacham/claude-skills#v1.0.9 --version`
...
```sh
npx -y github:christophacham/claude-skills#v1.0.9 uninstall   # confirm, then remove tracked global items
