...
npx -y github:christophacham/claude-skills#v1.0.11
```

Same idea with Bun:

```sh
bunx github:christophacham/claude-skills#v1.0.11
```
...
Check what you ran: `npx -y github:christophacham/claude-skills#v1.0.11 --version`
...
```sh
npx -y github:christophacham/claude-skills#v1.0.11 uninstall   # confirm, then remove tracked global items
