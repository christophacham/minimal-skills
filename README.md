...
npx -y github:christophacham/claude-skills#v1.0.12
```

Same idea with Bun:

```sh
bunx github:christophacham/claude-skills#v1.0.12
```
...
Check what you ran: `npx -y github:christophacham/claude-skills#v1.0.12 --version`
...
```sh
npx -y github:christophacham/claude-skills#v1.0.12 uninstall   # confirm, then remove tracked global items
