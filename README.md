...
npx -y github:christophacham/claude-skills#v1.0.10
```

Same idea with Bun:

```sh
bunx github:christophacham/claude-skills#v1.0.10
```
...
Check what you ran: `npx -y github:christophacham/claude-skills#v1.0.10 --version`
...
```sh
npx -y github:christophacham/claude-skills#v1.0.10 uninstall   # confirm, then remove tracked global items
