...
npx -y github:christophacham/claude-skills#v1.0.13
```

Same idea with Bun:

```sh
bunx github:christophacham/claude-skills#v1.0.13
```
...
Check what you ran: `npx -y github:christophacham/claude-skills#v1.0.13 --version`
...
```sh
npx -y github:christophacham/claude-skills#v1.0.13 uninstall   # confirm, then remove tracked global items
