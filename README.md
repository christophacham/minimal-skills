...
npx -y github:christophacham/minimal-skills#v1.0.15
```

Same idea with Bun:

```sh
bunx github:christophacham/minimal-skills#v1.0.15
```
...
Check what you ran: `npx -y github:christophacham/minimal-skills#v1.0.15 --version`
