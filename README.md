...
npx -y github:christophacham/minimal-skills#v1.0.16
```

Same idea with Bun:

```sh
bunx github:christophacham/minimal-skills#v1.0.16
```
...
Check what you ran: `npx -y github:christophacham/minimal-skills#v1.0.16 --version`
...
```sh
npx -y github:christophacham/minimal-skills#v1.0.16 uninstall   # confirm, then remove tracked global items
