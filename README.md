...
npx -y github:christophacham/claude-skills#v1.0.4
```

Same idea with Bun:

```sh
bunx github:christophacham/claude-skills#v1.0.4
```
...
Check what you ran: `npx -y github:christophacham/claude-skills#v1.0.4 --version`
...
```sh
npx -y github:christophacham/claude-skills#v1.0.4 uninstall   # confirm, then remove tracked global items
